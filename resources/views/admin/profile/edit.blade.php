            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" value="{{ $news_form->neme }}">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 mx-auto">
                        <h2>編集履歴</h2>
                        <ul class="list-group">
                            @if ($news_form->tracks != NULL)
                                @foreach ($news_form->tracks as $track)
                                    <li class="list-group-item">{{ $track->edited_at }}</li>
                                @endforeach
                            @endif
                        </ul>
                    </div>
